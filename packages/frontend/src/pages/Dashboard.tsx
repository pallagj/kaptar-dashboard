...
export function Dashboard({ stats, batteryWarnV, batteryWarnPct = 20, batteryUnit = 'V', range, setRange }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        />
        <BatteryGauge voltage={stats.latest.battery} warnV={batteryUnit === '%' ? batteryWarnPct : batteryWarnV} unit={batteryUnit} />
      </div>
